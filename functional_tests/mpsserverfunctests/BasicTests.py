...
class BasicTests(BaseTest):
    ...
    def test_modules(self):
        ...
        self.assertEqual(
            "53e645ec-88f8-4ef4-b3c7-e9d92b8c4eff", protocolLanguage[0]["uuid"]
        )
        protocolLanguageSandbox = [
            m for m in data if m["name"] == "ProtocolLanguage.sandbox"
        ]
        self.assertEqual(1, len(protocolLanguageSandbox))
        self.assertEqual(
            "bb0b4740-c31b-4055-b888-4bba31abf5fe", protocolLanguageSandbox[0]["uuid"]
        )
